var normalizeData = function ( parsedData, routesScaleToSize, startDate, duration, frameRate ) {
    ...
    if ( coffLatitude < coffLongitude ) {

        coffLatitude = coffLongitude;

    } else {

        coffLongitude = coffLatitude;
